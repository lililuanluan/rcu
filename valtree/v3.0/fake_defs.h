...
/*
 * Atomic operations based on C11 standard atomic library.
 * These operations are supported under SC, TSO and PSO in GenMC.
 */
#define atomic_add(i, v) atomic_fetch_add_explicit(v, i, memory_order_relaxed)
#define atomic_add_return(i, v) (atomic_fetch_add_explicit(v, i, memory_order_relaxed) + (i))
...
#define atomic_inc_return(v) (atomic_fetch_add_explicit(v, 1, memory_order_relaxed) + 1)
#define atomic_dec(v) atomic_fetch_sub_explicit(v, 1, memory_order_relaxed)
#define atomic_dec_and_test(v) (atomic_fetch_sub_explicit(v, 1, memory_order_relaxed) == 1)
